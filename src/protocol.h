...
#define PROTMESSID_INCORRECT_PASSWORD         101 // incorrect password
...
public:
    ...
    void CreateIncorrectPasswordMes ();
...
protected:
    ...
    bool EvaluateIncorrectPassword      ( const CVector<uint8_t>& vecData );
