...
*/
    ...
    else
    {
        ...
        else
        {
            ...
            case PROTMESSID_INCORRECT_PASSWORD:
                bRet = EvaluateIncorrectPassword ( vecbyMesBodyData );
                break;
            }
...
void CProtocol::CreateIncorrectPasswordMes ()
{
    CVector<uint8_t> vecData ( 1 ); // 1 byte of data
    int              iPos = 0; // init position pointer
    // junk data
    ...
    CreateAndSendMessage ( PROTMESSID_INCORRECT_PASSWORD , vecData );
}

bool CProtocol::EvaluateIncorrectPassword ( const CVector<uint8_t>& vecData )
{
